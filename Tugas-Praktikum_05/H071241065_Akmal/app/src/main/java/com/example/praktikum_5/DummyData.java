...
public class DummyData {
    ...
    public static void initData() {
        ...
        // Gunakan package name com.example.praktikum_5
        String path = "android.resource://com.example.praktikum_5/drawable/";
        ...
        bookList.add(new Book("8", "Supernova", "Dee Lestari", 2001, "Romansa yang terjalin dalam dimensi sains dan spiritualitas.", path + "supernova", 4.5f, "Fiksi Ilmiah"));
